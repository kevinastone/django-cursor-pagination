...
class TestCursorManagerByPrimaryKey(TestCase):
	...
	def test_ordering_next_ascending(self):
		...
		for count in second_pks:
			self.assertGreater(count, max(first_pks), "Cursor didn't maintain ordering")
	...
	def test_ordering_previous_ascending(self):
		...
		self.assertFalse(first_pks & second_pks)
		for count in second_pks:
			self.assertLess(count, min(first_pks), "Cursor didn't maintain ordering")
...
class TestCursorManagerByInteger(TestCase):
	...
	def test_ordering_next_ascending(self):
		...
		for count in second_counts:
			self.assertGreaterEqual(count, max(first_counts), "Cursor didn't maintain ordering")
	...
	def test_ordering_previous_ascending(self):
		...
		for count in second_counts:
			self.assertLessEqual(count, min(first_counts), "Cursor didn't maintain ordering")
